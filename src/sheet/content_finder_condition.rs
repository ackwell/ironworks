...
pub struct ContentFinderCondition {
    ...
    pub r#icon: u32,
    pub r#unknown46: i8,
    pub r#level506070_roulette: i32,
...
impl ContentFinderCondition {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#class_job_level_required: row.field(15usize + offset)?.into_u8()?,
            r#class_job_level_sync: row.field(16usize + offset)?.into_u8()?,
            r#item_level_required: row.field(17usize + offset)?.into_u16()?,
            r#item_level_sync: row.field(18usize + offset)?.into_u16()?,
            r#unknown19: row.field(19usize + offset)?.into_bool()?,
            r#allow_undersized: row.field(20usize + offset)?.into_bool()?,
            r#allow_replacement: row.field(21usize + offset)?.into_bool()?,
            r#unknown22: row.field(22usize + offset)?.into_bool()?,
            r#allow_explorer_mode: row.field(23usize + offset)?.into_bool()?,
            ...
            r#high_end_duty: row.field(28usize + offset)?.into_bool()?,
            ...
            r#duty_recorder_allowed: row.field(33usize + offset)?.into_bool()?,
            ...
            r#name: row.field(38usize + offset)?.into_string()?,
            r#name_short: row.field(39usize + offset)?.into_string()?,
            r#content_type: row.field(40usize + offset)?.into_u8()?,
            r#transient_key: row.field(41usize + offset)?.into_u8()?,
            r#transient: row.field(42usize + offset)?.into_u32()?,
            r#sort_key: row.field(43usize + offset)?.into_u16()?,
            r#image: row.field(44usize + offset)?.into_u32()?,
            r#icon: row.field(45usize + offset)?.into_u32()?,
            r#unknown46: row.field(46usize + offset)?.into_i8()?,
            r#level506070_roulette: row.field(47usize + offset)?.into_i32()?,
            r#leveling_roulette: row.field(48usize + offset)?.into_bool()?,
            r#msq_roulette: row.field(49usize + offset)?.into_bool()?,
            r#guild_hest_roulette: row.field(50usize + offset)?.into_bool()?,
            r#expert_roulette: row.field(51usize + offset)?.into_bool()?,
            r#trial_roulette: row.field(52usize + offset)?.into_bool()?,
            r#daily_frontline_challenge: row.field(53usize + offset)?.into_bool()?,
            r#level80_roulette: row.field(54usize + offset)?.into_bool()?,
            r#mentor_roulette: row.field(55usize + offset)?.into_bool()?,
            ...
            r#alliance_roulette: row.field(61usize + offset)?.into_bool()?,
            r#feast_team_roulette: row.field(62usize + offset)?.into_bool()?,
            r#normal_raid_roulette: row.field(63usize + offset)?.into_bool()?,
        })
    }
}
