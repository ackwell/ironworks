...
pub struct BNpcParts {
    pub r#b_npc_base1: bool,
    pub r#part_slot1: u16,
    pub r#unknown2: u8,
    pub r#unknown3: bool,
    pub r#unknown4: bool,
    pub r#unknown5: bool,
    ...
    pub r#unknown9: f32,
    pub r#scale1: i16,
    pub r#b_npc_base2: f32,
    pub r#part_slot2: u16,
    pub r#unknown13: u8,
    ...
    pub r#unknown20: f32,
    pub r#scale2: i16,
    pub r#b_npc_base3: f32,
    pub r#part_slot3: u16,
    pub r#unknown24: u8,
    ...
    pub r#scale3: f32,
    pub r#unknown32: i16,
    pub r#b_npc_base4: f32,
    pub r#part_slot4: u16,
    pub r#unknown35: u8,
    ...
    pub r#unknown42: f32,
    pub r#scale4: i16,
    pub r#b_npc_base5: f32,
    pub r#part_slot5: u16,
    pub r#unknown46: u8,
...
impl BNpcParts {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            r#b_npc_base1: row.field(0usize + offset)?.into_bool()?,
            r#part_slot1: row.field(1usize + offset)?.into_u16()?,
            ...
            r#x1: row.field(6usize + offset)?.into_bool()?,
            r#y1: row.field(7usize + offset)?.into_f32()?,
            r#z1: row.field(8usize + offset)?.into_f32()?,
            r#unknown9: row.field(9usize + offset)?.into_f32()?,
            r#scale1: row.field(10usize + offset)?.into_i16()?,
            r#b_npc_base2: row.field(11usize + offset)?.into_f32()?,
            r#part_slot2: row.field(12usize + offset)?.into_u16()?,
            ...
            r#x2: row.field(17usize + offset)?.into_bool()?,
            ...
            r#scale2: row.field(21usize + offset)?.into_i16()?,
            r#b_npc_base3: row.field(22usize + offset)?.into_f32()?,
            r#part_slot3: row.field(23usize + offset)?.into_u16()?,
            ...
            r#x3: row.field(28usize + offset)?.into_bool()?,
            r#y3: row.field(29usize + offset)?.into_f32()?,
            r#z3: row.field(30usize + offset)?.into_f32()?,
            r#scale3: row.field(31usize + offset)?.into_f32()?,
            r#unknown32: row.field(32usize + offset)?.into_i16()?,
            r#b_npc_base4: row.field(33usize + offset)?.into_f32()?,
            r#part_slot4: row.field(34usize + offset)?.into_u16()?,
            ...
            r#x4: row.field(39usize + offset)?.into_bool()?,
            r#y4: row.field(40usize + offset)?.into_f32()?,
            r#z4: row.field(41usize + offset)?.into_f32()?,
            r#unknown42: row.field(42usize + offset)?.into_f32()?,
            r#scale4: row.field(43usize + offset)?.into_i16()?,
            r#b_npc_base5: row.field(44usize + offset)?.into_f32()?,
            r#part_slot5: row.field(45usize + offset)?.into_u16()?,
            ...
            r#x5: row.field(50usize + offset)?.into_bool()?,
            r#y5: row.field(51usize + offset)?.into_f32()?,
            r#z5: row.field(52usize + offset)?.into_f32()?,
            r#unknown53: row.field(53usize + offset)?.into_f32()?,
            r#scale5: row.field(54usize + offset)?.into_i16()?,
            r#unknown55: row.field(55usize + offset)?.into_f32()?,
            ...
            r#unknown62: row.field(62usize + offset)?.into_f32()?,
            r#unknown63: row.field(63usize + offset)?.into_f32()?,
            r#unknown64: row.field(64usize + offset)?.into_f32()?,
            r#unknown65: row.field(65usize + offset)?.into_i16()?,
            r#unknown66: row.field(66usize + offset)?.into_f32()?,
        })
    }
}
