...
impl AOZContent {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#act2_fight_type: row.field(6usize + offset)?.into_u8()?,
            r#act2: row.field(7usize + offset)?.into_u16()?,
            r#arena_type2: row.field(8usize + offset)?.into_u8()?,
            r#unknown9: row.field(9usize + offset)?.into_u16()?,
            r#act3_fight_type: row.field(10usize + offset)?.into_u8()?,
            r#act3: row.field(11usize + offset)?.into_u16()?,
            r#arena_type3: row.field(12usize + offset)?.into_u8()?,
            r#unknown13: row.field(13usize + offset)?.into_u16()?,
            r#content_entry: row.field(14usize + offset)?.into_u32()?,
            r#order: row.field(15usize + offset)?.into_u8()?,
            r#gil_reward: row.field(16usize + offset)?.into_u16()?,
            r#allied_seals_reward: row.field(17usize + offset)?.into_u16()?,
            r#tomestones_reward: row.field(18usize + offset)?.into_u16()?,
        })
    }
}
