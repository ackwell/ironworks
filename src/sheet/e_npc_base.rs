...
pub struct ENpcBase {
    ...
    pub r#invisibility: u16,
    pub r#balloon: u8,
    pub r#not_rewrite_height: u16,
    pub r#default_balloon: bool,
    pub r#unknown108: u8,
    pub r#unknown109: u8,
}
impl ENpcBase {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#dye2_main_hand: row.field(67usize + offset)?.into_u8()?,
            r#model_off_hand: row.field(68usize + offset)?.into_u64()?,
            r#dye_off_hand: row.field(69usize + offset)?.into_u8()?,
            r#dye2_off_hand: row.field(70usize + offset)?.into_u8()?,
            r#model_head: row.field(71usize + offset)?.into_u32()?,
            r#dye_head: row.field(72usize + offset)?.into_u8()?,
            r#dye2_head: row.field(73usize + offset)?.into_u8()?,
            r#visor: row.field(74usize + offset)?.into_bool()?,
            r#model_body: row.field(75usize + offset)?.into_bool()?,
            r#dye_body: row.field(76usize + offset)?.into_u32()?,
            r#dye2_body: row.field(77usize + offset)?.into_u8()?,
            r#model_hands: row.field(78usize + offset)?.into_u8()?,
            r#dye_hands: row.field(79usize + offset)?.into_u32()?,
            r#dye2_hands: row.field(80usize + offset)?.into_u8()?,
            r#model_legs: row.field(81usize + offset)?.into_u8()?,
            r#dye_legs: row.field(82usize + offset)?.into_u32()?,
            r#dye2_legs: row.field(83usize + offset)?.into_u8()?,
            r#model_feet: row.field(84usize + offset)?.into_u8()?,
            r#dye_feet: row.field(85usize + offset)?.into_u32()?,
            r#dye2_feet: row.field(86usize + offset)?.into_u8()?,
            r#model_ears: row.field(87usize + offset)?.into_u8()?,
            r#dye_ears: row.field(88usize + offset)?.into_u32()?,
            r#dye2_ears: row.field(89usize + offset)?.into_u8()?,
            r#model_neck: row.field(90usize + offset)?.into_u8()?,
            r#dye_neck: row.field(91usize + offset)?.into_u32()?,
            r#dye2_neck: row.field(92usize + offset)?.into_u8()?,
            r#model_wrists: row.field(93usize + offset)?.into_u8()?,
            r#dye_wrists: row.field(94usize + offset)?.into_u32()?,
            r#dye2_wrists: row.field(95usize + offset)?.into_u8()?,
            r#model_left_ring: row.field(96usize + offset)?.into_u8()?,
            r#dye_left_ring: row.field(97usize + offset)?.into_u32()?,
            r#dye2_left_ring: row.field(98usize + offset)?.into_u8()?,
            r#model_right_ring: row.field(99usize + offset)?.into_u8()?,
            r#dye_right_ring: row.field(100usize + offset)?.into_u32()?,
            r#dye2_right_ring: row.field(101usize + offset)?.into_u8()?,
            r#unknown102: row.field(102usize + offset)?.into_u8()?,
            r#unknown103: row.field(103usize + offset)?.into_u16()?,
            r#invisibility: row.field(104usize + offset)?.into_u16()?,
            r#balloon: row.field(105usize + offset)?.into_u8()?,
            r#not_rewrite_height: row.field(106usize + offset)?.into_u16()?,
            r#default_balloon: row.field(107usize + offset)?.into_bool()?,
