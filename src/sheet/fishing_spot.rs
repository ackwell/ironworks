...
impl FishingSpot {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#fishing_spot_category: row.field(4usize + offset)?.into_u8()?,
            r#rare: row.field(5usize + offset)?.into_bool()?,
            r#territory_type: row.field(6usize + offset)?.into_u16()?,
            r#place_name_main: row.field(7usize + offset)?.into_u16()?,
            r#place_name_sub: row.field(8usize + offset)?.into_u16()?,
            r#x: row.field(9usize + offset)?.into_i16()?,
            r#z: row.field(10usize + offset)?.into_i16()?,
            r#radius: row.field(11usize + offset)?.into_u16()?,
            ...
            r#place_name: row.field(23usize + offset)?.into_u16()?,
            r#order: row.field(24usize + offset)?.into_u16()?,
        })
    }
}
