...
pub struct ClassJob {
    ...
    pub r#name_english: u8,
    pub r#item_starting_weapon: SeString,
    pub r#unknown31: i32,
    pub r#role: i32,
    pub r#starting_town: u8,
    pub r#monster_note: u8,
    pub r#primary_stat: i8,
    pub r#limit_break1: u8,
    pub r#limit_break2: u16,
    pub r#limit_break3: u16,
    pub r#ui_priority: u16,
    pub r#item_soul_crystal: u8,
    pub r#unlock_quest: u32,
    pub r#relic_quest: u32,
    pub r#prerequisite: u32,
    pub r#starting_level: u32,
    pub r#party_bonus: u8,
    pub r#unknown46: u8,
    pub r#is_limited_job: u8,
...
impl ClassJob {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#unknown23: row.field(23usize + offset)?.into_i32()?,
            r#unknown24: row.field(24usize + offset)?.into_i32()?,
            r#unknown25: row.field(25usize + offset)?.into_i32()?,
            r#pv_p_action_sort_row: row.field(26usize + offset)?.into_u8()?,
            r#unknown27: row.field(27usize + offset)?.into_u8()?,
            r#class_job_parent: row.field(28usize + offset)?.into_u8()?,
            r#name_english: row.field(29usize + offset)?.into_u8()?,
            r#item_starting_weapon: row.field(30usize + offset)?.into_string()?,
            r#unknown31: row.field(31usize + offset)?.into_i32()?,
            r#role: row.field(32usize + offset)?.into_i32()?,
            r#starting_town: row.field(33usize + offset)?.into_u8()?,
            r#monster_note: row.field(34usize + offset)?.into_u8()?,
            r#primary_stat: row.field(35usize + offset)?.into_i8()?,
            r#limit_break1: row.field(36usize + offset)?.into_u8()?,
            r#limit_break2: row.field(37usize + offset)?.into_u16()?,
            r#limit_break3: row.field(38usize + offset)?.into_u16()?,
            r#ui_priority: row.field(39usize + offset)?.into_u16()?,
            r#item_soul_crystal: row.field(40usize + offset)?.into_u8()?,
            r#unlock_quest: row.field(41usize + offset)?.into_u32()?,
            r#relic_quest: row.field(42usize + offset)?.into_u32()?,
            r#prerequisite: row.field(43usize + offset)?.into_u32()?,
            r#starting_level: row.field(44usize + offset)?.into_u32()?,
            r#party_bonus: row.field(45usize + offset)?.into_u8()?,
            r#unknown46: row.field(46usize + offset)?.into_u8()?,
            r#is_limited_job: row.field(47usize + offset)?.into_u8()?,
            r#can_queue_for_duty: row.field(48usize + offset)?.into_bool()?,
