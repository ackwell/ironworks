...
pub struct MountCustomize {
    ...
    pub r#hyur_midlander_female_camera_height: u8,
    pub r#hyur_highlander_male_camera_height: u8,
...
impl MountCustomize {
    pub fn populate(row: &Row, offset: usize) -> Result<Self, PopulateError> {
        Result::Ok(Self {
            ...
            r#viera_male_scale: row.field(16usize + offset)?.into_u16()?,
            r#viera_female_scale: row.field(17usize + offset)?.into_u16()?,
            ...
            r#hyur_highlander_female_camera_height: row
                ...
                .into_u8()?,
            r#elezen_male_camera_height: row.field(22usize + offset)?.into_u8()?,
            r#elezen_female_camera_height: row.field(23usize + offset)?.into_u8()?,
            r#lala_male_camera_height: row.field(24usize + offset)?.into_u8()?,
            r#lala_female_camera_height: row.field(25usize + offset)?.into_u8()?,
            r#miqo_male_camera_height: row.field(26usize + offset)?.into_u8()?,
            r#miqo_female_camera_height: row.field(27usize + offset)?.into_u8()?,
            r#roe_male_camera_height: row.field(28usize + offset)?.into_u8()?,
            r#roe_female_camera_height: row.field(29usize + offset)?.into_u8()?,
            r#au_ra_male_camera_height: row.field(30usize + offset)?.into_u8()?,
            r#au_ra_female_camera_height: row.field(31usize + offset)?.into_u8()?,
            r#hrothgar_male_camera_height: row.field(32usize + offset)?.into_u8()?,
            r#viera_male_camera_height: row.field(33usize + offset)?.into_u8()?,
            r#viera_female_camera_height: row.field(34usize + offset)?.into_u8()?,
        })
    }
}
